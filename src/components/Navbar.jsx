...
export default function Navbar() {
  ...
  return (
    <header className="fixed top-0 inset-x-0 z-50 bg-red-800 w-full shadow-md">
      <nav
      ...
      >
        ...
        <div className="flex lg:hidden">
          <button
            ...
            className="p-2.5 rounded-md text-white hover:bg-red-900 transition-colors"
          >
            ...
            <div className="flex gap-4 pt-6 border-t border-gray-200 mt-4">
              {[
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-xl text-red-800 hover:opacity-80 transition"
                >
                  <FontAwesomeIcon icon={icon} />
                </a>
              ))}
